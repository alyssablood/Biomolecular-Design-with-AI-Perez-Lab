...
The purpose in this tutorial is to make users comfortable with the PDB and analyzing 3D protein structures
...
5. Go back and click on the Structure tab to the right of Structure Summary. This provides you with an interactive model of Hemoglobin, with the amino acid sequence displayed up top and the model below. If you click on a certian amino acid in the sequence, the model will zoom into that amino acid. Practice turning and zooming into the model. You can click on the reset zoom button on the right to reset the model. Each chain is colored differently. 
