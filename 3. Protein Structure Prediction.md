...
To figure this out, we must perform a **Multiple Sequence Alignment (MSA)** with visualization software. For this tutorial, I will choose ChimeraX. 
...
Open the experimental PDB model 7bbv
Type open 7bbv in the command line and hit enter
