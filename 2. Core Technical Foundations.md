...
## Terminal-based Command Line Interfaces**
...
It is crucial to have spaces between each command and its arguments. A backslash \ character can be used to continue a line, which helps make complicated input more readable. Multiple commands can be run simultaneously using the UNIX "pipe" operator |. A table of essential commands and their functions is listed below. 
